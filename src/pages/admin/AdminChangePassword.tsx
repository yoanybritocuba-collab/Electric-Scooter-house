        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
          ...
          <form onSubmit={handleChangePassword} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-3 text-white outline-none focus:border-primary/50 transition-all pr-12"
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-primary to-primary/80 text-white font-bold py-4 rounded-xl hover:shadow-lg hover:shadow-primary/20 transition-all disabled:opacity-50 text-lg"
            >
              {loading 
