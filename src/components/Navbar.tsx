        ...
        <div className="w-full h-full flex items-center justify-between px-4 md:px-6 lg:px-8">
          ...
          <div className="hidden lg:flex items-center gap-3 xl:gap-4 ml-2 xl:ml-4">
            <button
              ...
              aria-label={getText("Buscar", "Search", "Αναζήτηση")}
            >
              <Search size={18} />
              <span className="text-xs hidden xl:inline">{getText("Buscar", "Search", "Αναζήτηση")}</span>
            </button>
            ...
            >
              ...
              <span className="hidden lg:inline text-xs ml-1">{t("nav.cart")}</span>
              {totalItems > 0 && (
        ...
        {menuOpen && (
          ...
          >
            <div className="flex flex-col items-center justify-start pt-4 pb-8">
              ...
              >
                <Search size={20} />
                {getText("Buscar", "Search", "Αναζήτηση")}
              </button>
              ...
              {/* Perfil - TRADUCIDO */}
              <button
                onClick={() => handleNavigation(user ? "/perfil" : "/login")}
              ...
              {/* REDES SOCIALES - CON TRADUCCIÓN */}
              <div className="w-full">
                <p className="w-full py-4 text-center text-white text-lg font-bold">
                  🌐 {t("social.social_media") || getText("REDES SOCIALES", "SOCIAL MEDIA", "ΚΟΙΝΩΝΙΚΑ ΔΙΚΤΥΑ")}
                </p>
                <div className="flex flex-wrap items-center justify-center gap-6 py-4">
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-400">{t("social.facebook")}</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-400">{t("social.instagram")}</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-400">{t("social.youtube")}</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-400">{t("social.twitter")}</span>
                  </a>
                </div>
              </div>
            </div>
