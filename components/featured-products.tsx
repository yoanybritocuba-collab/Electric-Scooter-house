      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            {language === 'en' ? 'Featured Products' : 'Προτεινόμενα Προϊόντα'}
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            {language === 'en'
              ? 'Discover our most popular electric vehicles, handpicked for quality and performance.'
              : 'Ανακαλύψτε τα πιο δημοφιλή ηλεκτρικά οχήματά μας, επιλεγμένα για ποιότητα και απόδοση.'}
          </p>
        </div>
