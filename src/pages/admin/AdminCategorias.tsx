        ...
        {loading ? (
          ...
          <div className="space-y-6">
            {categorias.map((cat) => (
              <div 
                key={cat.id} 
                className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 hover:border-primary/30 transition-all"
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm text-slate-400 mb-1">ID (fijo)</label>
                    <input
                      value={cat.id}
                      disabled
                      className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-3 text-slate-500 opacity-50"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-3 text-white focus:border-primary/50 transition-all"
                    />
                  </div>
                  <div>
                    ...
                    <div className="flex gap-4 items-start">
                      ...
                      <div className="flex-1">
                        <input
                          ...
                          className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-3 text-white mb-3 focus:border-primary/50 transition-all"
                        />
                        <label className="inline-flex items-center gap-2 bg-slate-700 hover:bg-slate-600 text-white px-4 py-2 rounded-xl cursor-pointer transition-colors">
                          <Upload size={16} />
