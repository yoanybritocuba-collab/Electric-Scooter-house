...
export interface DataSourceItem extends Omit<InternalItem, 'sourceId'>, Required<Pick<InternalItem, 'sourceId'>> {
}
 ...
 */
export type ItemRef<NodeType extends HTMLElement = HTMLElement> = MutableRefObject<NodeType | null>;
export type EnsuredItemRef<NodeType extends HTMLElement = HTMLElement> = MutableRefObject<NodeType>;
export interface InternalAPI {
    remove: (ref: ItemRef) => void;
    set: (ref: ItemRef, data: InternalItem) => void;
    handleClick: (ref?: ItemRef | null, targetId?: string | null, itemIndex?: number | null, e?: MouseEvent | null) => void;
    open: (i: number) => void;
    close: () => void;
