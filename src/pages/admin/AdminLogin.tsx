    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <div className="inline-flex p-4 bg-purple-500/10 rounded-2xl border border-purple-500/30 shadow-[0_0_30px_rgba(147,51,234,0.2)] mb-4">
        ...
        <div className="bg-[#0a0a0a] rounded-2xl border border-purple-900/30 p-8 shadow-[0_0_30px_rgba(0,0,0,0.5)] hover:shadow-[0_0_40px_rgba(147,51,234,0.2)] transition-all">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-black/50 border border-purple-900/30 rounded-xl pl-10 pr-4 py-3 text-white placeholder:text-gray-600 outline-none focus:border-purple-500/50 transition-all"
            ...
            <button
              ...
              className="w-full bg-purple-500/20 text-purple-500 font-bold py-3 rounded-xl hover:bg-purple-500/30 transition-all border border-purple-500/30 shadow-[0_0_15px_rgba(147,51,234,0.1)] hover:shadow-[0_0_25px_rgba(147,51,234,0.3)] disabled:opacity-50 flex items-center justify-center gap-2"
            >
              <LogIn size={18} />
              {loading
