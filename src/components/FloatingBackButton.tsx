    ...
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-black border-t border-gray-800 md:hidden z-50">
        <div className="flex items-center justify-around h-16">
          ...
          <button onClick={() => setShowCategories(true)} className="flex-1 flex items-center justify-center">
            <Grid size={24} className="text-gray-400" />
          </button>
          <button onClick={() => setShowSearch(true)} className="flex-1 flex items-center justify-center">
