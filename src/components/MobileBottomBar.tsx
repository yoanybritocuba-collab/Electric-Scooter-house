...
const MobileBottomBar = () => {
  ...
  return (
    <>
      {/* BARRA INFERIOR - CON TRADUCCIONES */}
      <div className="fixed bottom-0 left-0 right-0 bg-black border-t border-gray-800 md:hidden z-50 h-16">
        <div className="flex items-center justify-around h-full">
          ...
          >
            ...
            <span className="sr-only">{t("home.categories")}</span>
          </button>
      ...
      {/* Modales */}
      <SmartSearch open={showSearch} onClose={() => setShowSearch(false)} />
